...
- **Wallet Interface**: Facilitates invoice payments through various wallet implementations, starting with `LND`  and `NWC` wallet support.
...
[Doc.rs](https://docs.rs/rust-l402)
